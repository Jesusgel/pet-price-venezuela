...
import { ArrowLeft, ArrowRight, PackageSearch, Plus } from 'lucide-react';
...
export default function Home() {
  ...
  const [sortKey, setSortKey] = useState(0); // índice en SORT_OPTIONS
  ...
  // Reset página cuando cambian los filtros o el orden
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
          ...
          <div className="flex flex-col w-full md:w-auto gap-4 md:items-end">
            ...
            {/* Fila 2: Búsqueda + Categoría + Orden */}
